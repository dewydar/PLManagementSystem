...
+(function (a) {
    ...
    (function (a) {
        ...
        (g.prototype.activate = function () {
            ...
            this.options.slimscroll && void 0 !== a.fn.slimScroll &&
             ...
             //isf Update 2020-07-08 
            var lastSidebarPositon = getCookie("SidbarPositon");
          
            if (lastSidebarPositon != " ") {
                
                $('.sidebar').slimScroll({ scrollTo: lastSidebarPositon + 'px' }); 
            }
