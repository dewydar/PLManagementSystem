...
namespace PLManagementSystem.UI.Controllers
{
    public class ClassController : Controller
    {
        ...
        #region Filter
        private ClassFilterVM FillListFiltersFromQueryString()
        {
            var filters = new ClassFilterVM();
            filters.name = Request.Query["name"];

            return filters;
        }
        private Dictionary<string, string> GetFilterAsDictionary(ClassFilterVM filter)
        {
        ...
        private SortVM FillSortModelFromQueryString()
        {
            ...
            {
                result.SortColumn = nameof(ResponseClassDto.OrderNo);
            }
        ...
        private List<TableCloumnVM> GetTableCoulmns()
        {
            ...
            {
               new TableCloumnVM {ColumnName = nameof(ResponseClassDto.OrderNo),ColumnDisplayName="Order No", IsShow = true,IsSortable=true},
               new TableCloumnVM {ColumnName = nameof(ResponseClassDto.Id),ColumnDisplayName="Id", IsShow = true,IsSortable=true},
               new TableCloumnVM {ColumnName = nameof(ResponseClassDto.Name),ColumnDisplayName="Name", IsShow = true,IsSortable=true}
            };
        ...
        public async Task<IActionResult> Index(int PageIndex = 1)
        {
            ...
            var paginationResponseModelV2 = new PaginationResponseModelV2(PageIndex: PageIndex, ReturnData: (List<ResponseClassDto>)ProxyResponse.ReturnData,
        ...
        public IActionResult GetListFromFilters(ClassFilterVM filters)
        {
        ...
        public async Task<IActionResult> Create([FromForm] RequestClassDto NewRecord)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [FromForm] RequestClassDto RecordUpdated, int PageIndex)
        {
